...
| 场景 | 读取文档 |
|------|---------|
| 需要精确坐标/布局数值（Z1~Z4 Y值、卡牌尺寸等） | `docs/前端布局图示.md` |
| 需要了解组件结构、API 端点列表、颜色体系 | `docs/前端UI结构.md` |
| 需要直接复用代码片段（BoardRow/CardView/场景切换） | `docs/前端代码示例.md` |
| 需要看完整的组件源码实现 | `docs/autocard_code_reference.md` |

**不要把整篇文档都读完** — 用文件内的章节标题定位到需要的部分再读即可。
