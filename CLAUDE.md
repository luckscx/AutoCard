...
所有文档统一在 `docs/` 目录，按子目录分类。**任何时候需要生成文档，必须放在 `docs/` 目录下，不得在根目录或其他位置创建 `.md` 文件。**

**游戏设计** (`docs/game-design/`)
- `Meta构筑.md` — 游戏核心机制、端口体系、Meta 构筑策略
- `战斗逻辑.md` — 战斗系统详细设计
- `大巴扎分析.md` — 大巴扎 991 张卡牌统计分析
...
- `开发路线图.md` — 当前进度与待办项
- `代码参考.md` — 关键文件完整源码快照
- `怪物战斗Bug修复.md` — 怪物点击战斗 Bug 完整分析与修复记录

**前端** (`docs/frontend/`)
- `UI结构.md` — 前端组件库、场景布局、状态管理
- `布局图示.md` — 前端 ASCII 布局图、坐标速查
- `代码示例.md` — 前端常用代码片段（18个示例）
- `前端分析.md` — 前端代码结构分析、等级棋盘参考

**前端 · 拖拽系统** (`docs/frontend/drag/`)
- `拖拽系统概述.md` — 拖拽系统文档索引与交付总结
- `架构与分析.md` — 完整架构参考、详细分析、高级模式
- `关键代码片段.md` — 拖拽系统关键代码

**前端 · 音效系统** (`docs/frontend/audio/`)
- `音效集成指南.md` — 音效系统集成与关键路径速查
- `快速参考.md` — 音效系统快速参考卡
